...
volatile uint8_t readCount = 0;       // счетчик списанных байт
...
volatile uint32_t k[4], b[4];         // массив с данными ключа и блока
...
void InitAll() {
    ...
    /* Настройка портов приема и вывода */
...
/* Преобразование массива из 32-х символов в массив из четырех элементов по 4 байта */
